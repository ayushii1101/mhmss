...
<%
    ...
    String monthName = cal.getDisplayName(Calendar.MONTH, Calendar.SHORT, java.util.Locale.getDefault());  // e.g., "Jan"
    
    // daysInMonth
    int daysInMonth = cal.getActualMaximum(Calendar.DAY_OF_MONTH);
    
    // startOffset: first day of month as Sun=1...Sat=7, offset for Sun start
    int startOffset = (cal.get(Calendar.DAY_OF_WEEK) + 5) % 7;  // Adjust if week starts Mon
...
.dashboard-bg {
    ...
    background:
        ...
        url("https://images.unsplash.com/photo-1499946981954-e7f4b234d7fa?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D");
...
<div class="main">
    ...
    <div class="left-panel2">
        ...
        <div class="cards">
            <div class="card">
                <h3>Case Details</h3>
                <a href="<%= request.getContextPath() %>/CounselorCaseDetails.jsp"
                   class="session-btn">
            ...
            <div class="card">
                ...
                <a href="<%= request.getContextPath() %>/CounselorAppointments.jsp"
       class="session-btn">
        <button>Open</button>
    </a>            
            </div>
            ...
            <div class="card">
                ...
                <a href="<%= request.getContextPath() %>/CounselorReferredCases.jsp"
                   class="session-btn">
                <button>View Cases</button>
                </a>
            </div>
            ...
            <div class="card">
                <h3>Session Notes</h3>
                <a href="<%= request.getContextPath() %>/CounselorSessionNotes.jsp"
                   class="session-btn">
            ...
            <div class="card">
                <h3>Workshops</h3>
                <a href="<%= request.getContextPath() %>/CounselorWorkshops.jsp"
                   class="session-btn">
            ...
            <div class="card">       
                ...
                <a href="<%= request.getContextPath() %>/CounselorTimetable.jsp"
                   class="session-btn">
...
<% } %>
        ...
        <p style="margin-top:10px;font-size:12px;">
            <b>Today:</b> Therapy Session
             ...
             <script>// Close dropdown when clicking outside
