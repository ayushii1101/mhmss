...
<body>
    ...
    <div id="login" class="tab active">
        <form method="post" action="FacultyLoginProcess.jsp">
            <input type="hidden" name="role" value="faculty">
            
            <label>Email:</label>
            <input type="text" name="facultyEmail" required value="<%= request.getAttribute("enteredEmail") != null ? request.getAttribute("enteredEmail") : "" %>">
